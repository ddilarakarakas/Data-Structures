public class BinarySearchTree<E extends Comparable<E>> extends BinaryTree<E> implements SearchTree<E>{
    ...
    public BinarySearchTree(BinaryTree<E> tree) {
        if(tree != null)
            this.root = tree.root;
    }
    ...
    public BinarySearchTree<E> getLeftSubTree(BinarySearchTree<E> o){
        return new BinarySearchTree<>(o.getLeftSubtree());
    }
    public BinarySearchTree<E> getRightSubTree(BinarySearchTree<E> o){
        return new BinarySearchTree<>(o.getRightSubtree());
    }
